...
SCHEMA_PATH = Path('D:/WorkStation/hepPost/backend/fastapi_heppost/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'D:/WorkStation/hepPost/backend/fastapi_heppost/prisma/schema.prisma',
        }
